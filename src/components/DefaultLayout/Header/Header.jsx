      ...
      <header className="flex bg-primary border-b py-4 sm:px-8 px-6 font-[sans-serif] min-h-[80px] tracking-wide relative z-50">
        <div className="flex flex-wrap items-center lg:gap-y-2 gap-4 w-full">
          ...
          <div className="flex gap-x-10 gap-y-4 ml-2">
            <div className="flex w-full border-2 gap-2  bg-white focus-within:border-gray-400 rounded-none px-12 py-1 overflow-hidden  max-lg:hidden">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <input
                type="text"
                placeholder="Search for products,services or more"
                className="w-full text-sm bg-white outline-none pr-6"
              />
            </div>
          </div>

          <div className="flex gap-x-10 gap-y-4 ml-auto">
            <div className="flex items-center space-x-8 mr-3 px-4">
              ...
              <span className="relative">
                <img src={Fav} />
                <span className="absolute left-auto ml-9 top-0 rounded-full bg-red-500 px-1 py-0 text-xs text-white">
                  0
                </span>
              </span>
